...
<head>
    ...
    <link rel="stylesheet" href="css/int-tft.css">
...
<body>
    ...
    <section class="container-prim">
        <main>
            ...
            <div class="data-container-center">
                <div class="data-column">
                    <ul>
                        <?php
                        $palmares = array(      
                            array("nom" => "Golden Spatula Cup #2", "joueur" => "USM Flwders" , "position" => "Top 30"),
                            array("nom" => "Golden Spatula Cup #1", "joueur" => "USM Flwders", "position" => "Top 42"),
                        );
            ...
            <div class="data-container-center">
                <div class="data-column">
                    <ul>
                        <?php
                        $palmares = array(
                            array("nom" => "Hex Tour: Ultimate Maestro","joueur"=> "Usm Bellae", "position" => "Top 07"),
                        );
                        foreach ($palmares as $item) {
                            if ($item['position'] == '1ère place') {
                                echo "<li class=palmares-nom>" . $item['nom'] ." | ". $item['joueur']. " - " . "<span class='or'>" . $item['position'] . "</span>" . "</li>";
            ...
            <h2 class='annee'>2020</h2>
            <div class="data-container-center">
                <div class="data-column">
                    <ul>
                        <?php
                        $palmares = array(
                            array("nom" => "Worlds", "joueur" => "USM Faellan" , "position" => "Top 64"),
                        );
                        foreach ($palmares as $item) {
                            if ($item['position'] == '1ère place') {
                                echo "<li class=palmares-nom>" . $item['nom'] ." | ". $item['joueur']. " - " . "<span class='or'>" . $item['position'] . "</span>" . "</li>";
