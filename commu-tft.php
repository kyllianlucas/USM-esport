...
<head>
    ...
    <link rel="stylesheet" href="css/commu-tft.css">
            ...
            <div class="data-container-center">
                <div class="data-column">
                    <ul>
                        <?php
                            $palmares = array(
                            array("nom" => "HexTour #1", "joueur" => "USM Bellae", "position" => "7ème place")
                            );
            ...
            <div class="data-container-center">
                <div class="data-column">
                    <ul>
                        <?php
                        $palmares = array(
                            array("nom" => "Partenaire Tour", "date" => "2022" , "joueur" => " USM Yobidashi", "position" => "1ère place")
                        );
                        foreach ($palmares as $item) {
                            if ($item['position'] == '1ère place') {
                                echo "<li class=palmares-nom>" . $item['nom'] ." | ". $item['joueur']. " - " ."<span class='or'>" . $item['position'] . "</span>" . "</li>";
