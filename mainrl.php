...
<head>
    ...
    <link rel="stylesheet" href="css/mainRl.css">
        ...
        <main>
            <ul class="list-group">
                <li class="list-group-item">
                    <img src="./asset/img/bouzork.png" alt="ZeGuillotin" class="rl-pic-img">
                ...
                <li class="list-group-item">
                    <img src="./asset/img/irhoZ.png" alt="ZeGuillotin" class="rl-pic-img">
               ...
               <li class="list-group-item">
                    <img src="./asset/img/dunkan.png" alt="ZeGuillotin" class="rl-pic-img">
                    <h3 class="rl-name">Dunkan</h3>
                    <br>
                    <div class="rl-logo">
                        <a href="https://twitter.com/ItsDunkan" target="_blank"><i class="fa-brands fa-twitter network-rl-twitter"></i></a>
                        <a href="https://rocketleague.tracker.network/rocket-league/profile/steam/76561198810569966/overview" target="_blank"><img src="./asset/img/rl.png"></a>
                    </div>
               </li>  
               <li class="list-group-item">
                    <img src="./asset/img/logo.png" alt="ZeGuillotin" class="rl-pic-logo">
                    <h3 class="rl-name">Wiginti(sub)</h3>
                    <br>
                    <div class="rl-logo">
            ...
            <ul class="list-group-second">
                <li class="list-group-item">
                    ...
                    <br>
                    <div class="rl-logo">
                        <a href="https://twitter.com/USM_Zoob" target="_blank"><i class="fa-brands fa-twitter network-rl-twitter"></i></a>
                    </div>
               </li>
               <!--<li class="list-group-item">
                    <img src="./asset/img/logo.png" alt="ZeGuillotin" class="rl-pic-logo">
                    <h3 class="rl-name">---</h3>
                    <h3 class="rl-poste">---</h3>
                    <br>
                    <div class="rl-logo">
                        <a href="https://twitter.com/SwaziaRL" target="_blank"><i class="fa-brands fa-twitter network-rl-twitter"></i></a>
                    </div>
                </li>-->
            </ul>
        </main>
